...
import InlineChunkHtmlPlugin from '../utils/InlineChunkHtmlPlugin.js';
import InterpolateHtmlPlugin from '../utils/InterpolateHtmlPlugin.js';
import ModuleScopePlugin from '../utils/ModuleScopePlugin.js';
...
export default function (webpackEnv) {
  ...
  return {
    ...
    performance: false,
    // To ignore warnings source-map-loader
